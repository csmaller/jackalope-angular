...
export const createBlog = createAction(
  '[Blog] Create Blog',
  props<{ blog: Omit<Blog, 'id' | 'createdAt' | 'updatedAt'> }>()
);
...
export const loadLatestBlogsSuccess = createAction(
  '[Blog] Load Latest Blogs Success',
  props<{ blogs: BlogWithAuthor[] }>()
);
export const loadLatestBlogsFailure = createAction(
  '[Blog] Load Latest Blogs Failure',
  props<{ error: string }>()
);
